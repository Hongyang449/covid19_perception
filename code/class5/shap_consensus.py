...
## total number of examples = 2350 = 235 * 10fold
## top words that have a frequency >10%
the_index = num_count >=235
...
df_top_abs.to_csv('tbl_shap_class5.csv', index=False)
